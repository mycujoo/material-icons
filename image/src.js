...
export {
    IconAddAPhoto,
    IconAddAPhoto as icon_add_a_photo,
}
...
export {
    IconAddToPhotos,
    IconAddToPhotos as icon_add_to_photos,
}
function IconAdjust() {
    return (
...
export {
    IconAssistant,
    IconAssistant as icon_assistant,
}
...
export {
    IconAssistantPhoto,
    IconAssistantPhoto as icon_assistant_photo,
}
...
export {
    IconAudiotrack,
    IconAudiotrack as icon_audiotrack,
}
...
export {
    IconBlurCircular,
    IconBlurCircular as icon_blur_circular,
}
...
export {
    IconBlurLinear,
    IconBlurLinear as icon_blur_linear,
}
...
export {
    IconBrightness1,
    IconBrightness1 as icon_brightness_1,
}
...
export {
    IconBrightness2,
    IconBrightness2 as icon_brightness_2,
}
...
export {
    IconBrightness3,
    IconBrightness3 as icon_brightness_3,
}
...
export {
    IconBrightness4,
    IconBrightness4 as icon_brightness_4,
}
...
export {
    IconBrightness5,
    IconBrightness5 as icon_brightness_5,
}
...
export {
    IconBrightness6,
    IconBrightness6 as icon_brightness_6,
}
...
export {
    IconBrightness7,
    IconBrightness7 as icon_brightness_7,
}
...
export {
    IconBrokenImage,
    IconBrokenImage as icon_broken_image,
}
function IconBrush() {
    return (
...
export {
    IconBurstMode,
    IconBurstMode as icon_burst_mode,
}
function IconCamera() {
    return (
...
export {
    IconCameraAlt,
    IconCameraAlt as icon_camera_alt,
}
...
export {
    IconCameraFront,
    IconCameraFront as icon_camera_front,
}
...
export {
    IconCameraRear,
    IconCameraRear as icon_camera_rear,
}
...
export {
    IconCameraRoll,
    IconCameraRoll as icon_camera_roll,
}
...
export {
    ...
    IconCenterFocusStrong as icon_center_focus_strong,
}
...
export {
    IconCenterFocusWeak,
    IconCenterFocusWeak as icon_center_focus_weak,
}
...
export {
    IconCollections,
    IconCollections as icon_collections,
}
...
export {
    ...
    IconCollectionsBookmark as icon_collections_bookmark,
}
...
export {
    IconColorLens,
    IconColorLens as icon_color_lens,
}
...
export {
    IconControlPoint,
    IconControlPoint as icon_control_point,
}
...
export {
    ...
    IconControlPointDuplicate as icon_control_point_duplicate,
}
...
export {
    IconCropFree,
    IconCropFree as icon_crop_free,
}
...
export {
    IconCropLandscape,
    IconCropLandscape as icon_crop_landscape,
}
...
export {
    IconCropOriginal,
    IconCropOriginal as icon_crop_original,
}
...
export {
    IconCropPortrait,
    IconCropPortrait as icon_crop_portrait,
}
...
export {
    IconCropRotate,
    IconCropRotate as icon_crop_rotate,
}
...
export {
    IconCropSquare,
    IconCropSquare as icon_crop_square,
}
function IconDehaze() {
    return (
...
export {
    IconExposureNeg1,
    IconExposureNeg1 as icon_exposure_neg_1,
}
...
export {
    IconExposureNeg2,
    IconExposureNeg2 as icon_exposure_neg_2,
}
...
export {
    IconExposurePlus1,
    IconExposurePlus1 as icon_exposure_plus_1,
}
...
export {
    IconExposurePlus2,
    IconExposurePlus2 as icon_exposure_plus_2,
}
...
export {
    IconExposureZero,
    IconExposureZero as icon_exposure_zero,
}
...
export {
    IconFilter9Plus,
    IconFilter9Plus as icon_filter_9_plus,
}
...
export {
    IconFilterBAndW,
    IconFilterBAndW as icon_filter_b_and_w,
}
...
export {
    ...
    IconFilterCenterFocus as icon_filter_center_focus,
}
...
export {
    IconFilterDrama,
    IconFilterDrama as icon_filter_drama,
}
...
export {
    IconFilterFrames,
    IconFilterFrames as icon_filter_frames,
}
...
export {
    IconFilterHdr,
    IconFilterHdr as icon_filter_hdr,
}
...
export {
    IconFilterNone,
    IconFilterNone as icon_filter_none,
}
...
export {
    IconFilterTiltShift,
    IconFilterTiltShift as icon_filter_tilt_shift,
}
...
export {
    IconFilterVintage,
    IconFilterVintage as icon_filter_vintage,
}
function IconFlare() {
    return (
...
export {
    IconFlashAuto,
    IconFlashAuto as icon_flash_auto,
}
...
export {
    IconFlashOff,
    IconFlashOff as icon_flash_off,
}
...
export {
    IconHdrStrong,
    IconHdrStrong as icon_hdr_strong,
}
...
export {
    ...
    IconImageAspectRatio as icon_image_aspect_ratio,
}
function IconIso() {
    return (
...
export {
    IconLandscape,
    IconLandscape as icon_landscape,
}
...
export {
    IconLeakRemove,
    IconLeakRemove as icon_leak_remove,
}
function IconLens() {
    return (
...
export {
    IconLinkedCamera,
    IconLinkedCamera as icon_linked_camera,
}
function IconLooks() {
    return (
...
export {
    IconLooksOne,
    IconLooksOne as icon_looks_one,
}
...
export {
    IconLooksTwo,
    IconLooksTwo as icon_looks_two,
}
function IconLoupe() {
    return (
...
export {
    ...
    IconMonochromePhotos as icon_monochrome_photos,
}
...
export {
    IconMovieCreation,
    IconMovieCreation as icon_movie_creation,
}
...
export {
    IconMovieFilter,
    IconMovieFilter as icon_movie_filter,
}
...
export {
    IconMusicNote,
    IconMusicNote as icon_music_note,
}
function IconNature() {
    return (
...
export {
    IconNaturePeople,
    IconNaturePeople as icon_nature_people,
}
...
export {
    IconNavigateBefore,
    IconNavigateBefore as icon_navigate_before,
}
...
export {
    IconNavigateNext,
    IconNavigateNext as icon_navigate_next,
}
...
export {
    IconPanoramaFishEye,
    IconPanoramaFishEye as icon_panorama_fish_eye,
}
...
export {
    ...
    IconPanoramaHorizontal as icon_panorama_horizontal,
}
...
export {
    ...
    IconPanoramaVertical as icon_panorama_vertical,
}
...
export {
    ...
    IconPanoramaWideAngle as icon_panorama_wide_angle,
}
function IconPhoto() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z"/></svg>
...
export {
    IconPhotoAlbum,
    IconPhotoAlbum as icon_photo_album,
}
...
export {
    IconPhotoCamera,
    IconPhotoCamera as icon_photo_camera,
}
...
export {
    IconPhotoFilter,
    IconPhotoFilter as icon_photo_filter,
}
...
export {
    IconPhotoLibrary,
    IconPhotoLibrary as icon_photo_library,
}
...
export {
    ...
    IconPhotoSizeSelectActual as icon_photo_size_select_actual,
}
...
export {
    ...
    IconPhotoSizeSelectLarge as icon_photo_size_select_large,
}
...
export {
    ...
    IconPhotoSizeSelectSmall as icon_photo_size_select_small,
}
...
export {
    IconPictureAsPdf,
    IconPictureAsPdf as icon_picture_as_pdf,
}
...
export {
    IconRemoveRedEye,
    IconRemoveRedEye as icon_remove_red_eye,
}
...
export {
    ...
    IconRotate90DegreesCcw as icon_rotate_90_degrees_ccw,
}
...
export {
    IconRotateLeft,
    IconRotateLeft as icon_rotate_left,
}
...
export {
    IconRotateRight,
    IconRotateRight as icon_rotate_right,
}
...
export {
    IconSlideshow,
    IconSlideshow as icon_slideshow,
}
...
export {
    IconStraighten,
    IconStraighten as icon_straighten,
}
function IconStyle() {
    return (
...
export {
    IconSwitchCamera,
    IconSwitchCamera as icon_switch_camera,
}
...
export {
    IconSwitchVideo,
    IconSwitchVideo as icon_switch_video,
}
...
export {
    IconTagFaces,
    IconTagFaces as icon_tag_faces,
}
...
export {
    IconTimelapse,
    IconTimelapse as icon_timelapse,
}
...
export {
    IconTimerOff,
    IconTimerOff as icon_timer_off,
}
...
export {
    IconTransform,
    IconTransform as icon_transform,
}
function IconTune() {
    return (
...
export {
    IconViewComfy,
    IconViewComfy as icon_view_comfy,
}
...
export {
    IconViewCompact,
    IconViewCompact as icon_view_compact,
}
...
export {
    IconWbCloudy,
    IconWbCloudy as icon_wb_cloudy,
}
...
export {
    IconWbIncandescent,
    IconWbIncandescent as icon_wb_incandescent,
}
...
export {
    IconWbIridescent,
    IconWbIridescent as icon_wb_iridescent,
}
