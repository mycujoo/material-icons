...
export {
    IconAddCircle,
    IconAddCircle as icon_add_circle,
}
...
export {
    ...
    IconAddCircleOutline as icon_add_circle_outline,
}
...
export {
    IconBackspace,
    IconBackspace as icon_backspace,
}
function IconBlock() {
    return (
...
export {
    IconContentCopy,
    IconContentCopy as icon_content_copy,
}
...
export {
    IconContentCut,
    IconContentCut as icon_content_cut,
}
...
export {
    IconContentPaste,
    IconContentPaste as icon_content_paste,
}
function IconCreate() {
    return (
...
export {
    IconDeleteSweep,
    IconDeleteSweep as icon_delete_sweep,
}
function IconDrafts() {
    return (
...
export {
    IconFilterList,
    IconFilterList as icon_filter_list,
}
function IconFlag() {
    return (
...
export {
    IconFontDownload,
    IconFontDownload as icon_font_download,
}
...
export {
    IconLowPriority,
    IconLowPriority as icon_low_priority,
}
function IconMail() {
    return (
...
export {
    IconMarkunread,
    IconMarkunread as icon_markunread,
}
...
export {
    IconMoveToInbox,
    IconMoveToInbox as icon_move_to_inbox,
}
...
export {
    IconNextWeek,
    IconNextWeek as icon_next_week,
}
function IconRedo() {
    return (
...
export {
    IconRemoveCircle,
    IconRemoveCircle as icon_remove_circle,
}
...
export {
    ...
    IconRemoveCircleOutline as icon_remove_circle_outline,
}
function IconReply() {
    return (
...
export {
    IconReplyAll,
    IconReplyAll as icon_reply_all,
}
function IconReport() {
    return (
...
export {
    IconSelectAll,
    IconSelectAll as icon_select_all,
}
function IconSend() {
    return (
...
export {
    IconTextFormat,
    IconTextFormat as icon_text_format,
}
...
export {
    IconUnarchive,
    IconUnarchive as icon_unarchive,
}
function IconUndo() {
    return (
