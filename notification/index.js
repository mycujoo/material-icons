...
export function airline_seat_flat() {
    return (
...
export function airline_seat_flat_angled() {
    return (
...
export function airline_seat_individual_suite() {
    return (
...
export function airline_seat_legroom_extra() {
    return (
...
export function airline_seat_legroom_normal() {
    return (
...
export function airline_seat_legroom_reduced() {
    return (
...
export function airline_seat_recline_extra() {
    return (
...
export function airline_seat_recline_normal() {
    return (
...
export function bluetooth_audio() {
    return (
...
export function confirmation_number() {
    return (
...
export function do_not_disturb() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8 0-1.85.63-3.55 1.69-4.9L16.9 18.31C15.55 19.37 13.85 20 12 20zm6.31-3.1L7.1 5.69C8.45 4.63 10.15 4 12 4c4.42 0 8 3.58 8 8 0 1.85-.63 3.55-1.69 4.9z"/></svg>
    )
}
export function do_not_disturb_alt() {
    return (
...
export function do_not_disturb_off() {
    return (
...
export function do_not_disturb_on() {
    return (
...
export function enhanced_encryption() {
    return (
...
export function event_available() {
    return (
...
export function folder_special() {
    return (
...
export function network_locked() {
    return (
...
export function ondemand_video() {
    return (
...
export function personal_video() {
    return (
...
export function phone_bluetooth_speaker() {
    return (
...
export function sim_card_alert() {
    return (
