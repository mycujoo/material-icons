...
export {
    IconAddToQueue,
    IconAddToQueue as icon_add_to_queue,
}
...
export {
    IconArtTrack,
    IconArtTrack as icon_art_track,
}
...
export {
    ...
    IconBrandingWatermark as icon_branding_watermark,
}
...
export {
    IconCallToAction,
    IconCallToAction as icon_call_to_action,
}
...
export {
    IconClosedCaption,
    IconClosedCaption as icon_closed_caption,
}
...
export {
    IconEqualizer,
    IconEqualizer as icon_equalizer,
}
...
export {
    IconFastForward,
    IconFastForward as icon_fast_forward,
}
...
export {
    IconFastRewind,
    IconFastRewind as icon_fast_rewind,
}
...
export {
    ...
    IconFeaturedPlayList as icon_featured_play_list,
}
...
export {
    IconFeaturedVideo,
    IconFeaturedVideo as icon_featured_video,
}
...
export {
    IconFiberDvr,
    IconFiberDvr as icon_fiber_dvr,
}
...
export {
    ...
    IconFiberManualRecord as icon_fiber_manual_record,
}
...
export {
    IconFiberNew,
    IconFiberNew as icon_fiber_new,
}
...
export {
    IconFiberPin,
    IconFiberPin as icon_fiber_pin,
}
...
export {
    ...
    IconFiberSmartRecord as icon_fiber_smart_record,
}
...
export {
    IconForward10,
    IconForward10 as icon_forward_10,
}
...
export {
    IconForward30,
    IconForward30 as icon_forward_30,
}
...
export {
    IconForward5,
    IconForward5 as icon_forward_5,
}
function IconGames() {
    return (
...
export {
    IconHighQuality,
    IconHighQuality as icon_high_quality,
}
...
export {
    IconLibraryAdd,
    IconLibraryAdd as icon_library_add,
}
...
export {
    IconLibraryBooks,
    IconLibraryBooks as icon_library_books,
}
...
export {
    IconLibraryMusic,
    IconLibraryMusic as icon_library_music,
}
function IconLoop() {
    return (
...
export {
    IconMusicVideo,
    IconMusicVideo as icon_music_video,
}
...
export {
    IconNewReleases,
    IconNewReleases as icon_new_releases,
}
...
export {
    IconNotInterested,
    IconNotInterested as icon_not_interested,
}
function IconNote() {
    return (
...
export {
    ...
    IconPauseCircleFilled as icon_pause_circle_filled,
}
...
export {
    ...
    IconPauseCircleOutline as icon_pause_circle_outline,
}
...
export {
    IconPlayArrow,
    IconPlayArrow as icon_play_arrow,
}
...
export {
    ...
    IconPlayCircleFilled as icon_play_circle_filled,
}
...
export {
    ...
    IconPlayCircleOutline as icon_play_circle_outline,
}
...
export {
    IconPlaylistAdd,
    IconPlaylistAdd as icon_playlist_add,
}
...
export {
    ...
    IconPlaylistAddCheck as icon_playlist_add_check,
}
...
export {
    IconPlaylistPlay,
    IconPlaylistPlay as icon_playlist_play,
}
function IconQueue() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-1 9h-4v4h-2v-4H9V9h4V5h2v4h4v2z"/></svg>
...
export {
    IconQueueMusic,
    IconQueueMusic as icon_queue_music,
}
...
export {
    IconQueuePlayNext,
    IconQueuePlayNext as icon_queue_play_next,
}
function IconRadio() {
    return (
...
export {
    IconRecentActors,
    IconRecentActors as icon_recent_actors,
}
...
export {
    IconRemoveFromQueue,
    IconRemoveFromQueue as icon_remove_from_queue,
}
function IconRepeat() {
    return (
...
export {
    IconRepeatOne,
    IconRepeatOne as icon_repeat_one,
}
...
export {
    IconReplay10,
    IconReplay10 as icon_replay_10,
}
function IconReplay() {
    return (
...
export {
    IconReplay30,
    IconReplay30 as icon_replay_30,
}
...
export {
    IconSkipNext,
    IconSkipNext as icon_skip_next,
}
...
export {
    IconSkipPrevious,
    IconSkipPrevious as icon_skip_previous,
}
...
export {
    IconSlowMotionVideo,
    IconSlowMotionVideo as icon_slow_motion_video,
}
function IconSnooze() {
    return (
...
export {
    IconSortByAlpha,
    IconSortByAlpha as icon_sort_by_alpha,
}
function IconStop() {
    return (
...
export {
    IconSubscriptions,
    IconSubscriptions as icon_subscriptions,
}
...
export {
    IconSubtitles,
    IconSubtitles as icon_subtitles,
}
...
export {
    IconSurroundSound,
    IconSurroundSound as icon_surround_sound,
}
...
export {
    IconVideoCall,
    IconVideoCall as icon_video_call,
}
...
export {
    IconVideoLabel,
    IconVideoLabel as icon_video_label,
}
...
export {
    IconVideoLibrary,
    IconVideoLibrary as icon_video_library,
}
...
export {
    IconVideocamOff,
    IconVideocamOff as icon_videocam_off,
}
...
export {
    IconVolumeDown,
    IconVolumeDown as icon_volume_down,
}
...
export {
    IconVolumeMute,
    IconVolumeMute as icon_volume_mute,
}
...
export {
    IconVolumeOff,
    IconVolumeOff as icon_volume_off,
}
...
export {
    IconVolumeUp,
    IconVolumeUp as icon_volume_up,
}
function IconWeb() {
    return (
...
export {
    IconWebAsset,
    IconWebAsset as icon_web_asset,
}
