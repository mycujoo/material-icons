...
export function call_to_action() {
    return (
...
export function closed_caption() {
    return (
...
export function featured_play_list() {
    return (
...
export function featured_video() {
    return (
...
export function high_quality() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 4H5c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 11H9.5v-2h-2v2H6V9h1.5v2.5h2V9H11v6zm7-1c0 .55-.45 1-1 1h-.75v1.5h-1.5V15H14c-.55 0-1-.45-1-1v-4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v4zm-3.5-.5h2v-3h-2v3z"/></svg>
    )
}
export function library_add() {
    return (
...
export function not_interested() {
    return (
...
export function pause_circle_filled() {
    return (
...
export function pause_circle_outline() {
    return (
...
export function play_circle_outline() {
    return (
...
export function playlist_add_check() {
    return (
...
export function queue_play_next() {
    return (
...
export function remove_from_queue() {
    return (
...
export function surround_sound() {
    return (
